      ...
      <aside class="sidebar">
        ...
        <section class="sb-section">
          ...
          <div class="sb-item">
            ...
            <span>{{ cvData.datosPersonales?.email }}</span>
          </div>
          <div class="sb-item">
            <span class="sb-icon">📱</span>
            <span>{{ cvData.datosPersonales?.telefono }}</span>
          </div>
          <div class="sb-item">
            <span class="sb-icon">📍</span>
            <span>{{ cvData.datosPersonales?.direccion }}, {{ cvData.datosPersonales?.localidad }}</span>
          </div>
        ...
        <section v-if="cvData.idiomas?.length" class="sb-section">
          ...
          <div v-for="(lang, i) in cvData.idiomas" :key="i" class="sb-lang">
            ...
            <div class="sb-lang-bar">
              <div class="sb-lang-fill" :style="{ width: nivelPct(lang.nivel) + '%' }"></div>
            </div>
          </div>
        </section>
      ...
      <main class="main">
        ...
        <header class="main-header">
          <h1 class="main-name">
            ...
            <span>{{ cvData.datosPersonales?.apellido }}</span>
          </h1>
            ...
            <div class="main-entry-content">
              <div class="main-entry-top">
                ...
                <span class="main-entry-badge">
                  ...
                  {{ exp.actualidad ? 'Actualidad' : ((exp.mesFin || '') + ' ' + (exp.anioFin || '')) }}
                </span>
              </div>
